...
bool CProductIOControl::IsInputTrayTiltSensorOn()
{
	int nStatus = m_cIO->ReadInput(m_CardTray32In32Out2_2, 9);
	if (nStatus == 1)
		return true;
	else if (nStatus == 0)
		return false;
...
bool CProductIOControl::IsOutputTrayTiltSensorOn()
{
	int nStatus = m_cIO->ReadInput(m_CardTray32In32Out2_2, 21);
	if (nStatus == 1)
		return true;
	else if (nStatus == 0)
		return false;
...
bool CProductIOControl::IsS1RetractSensor()
{
	int nStatus = m_cIO->ReadInput(m_CardTray32In32Out2_2, 29);
	if (nStatus == 1)
		return true;
	else if (nStatus == 0)
		return false;
