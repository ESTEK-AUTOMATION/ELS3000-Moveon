...
int MapSettingBoolProduct(map<string, bool*> *mapSettingBool, CustomerSharedMemorySetting *customerSharedMemorySetting)
{
	...
	(*mapSettingBool).insert(pair<string, bool*>("EnableOutputTableVacuum", &customerSharedMemorySetting->EnableOutputTableVacuum));
...
int MapSettingSignedLongProduct(map<string, signed long*> *mapSettingSignedLong, CustomerSharedMemorySetting *customerSharedMemorySetting)
{
	...
	(*mapSettingSignedLong).insert(pair<string, signed long*>("ContinuouslyEmptyPocket", &customerSharedMemorySetting->ContinuouslyEmptyPocket));
...
int MapSettingUnsignedIntProduct(map<string, unsigned int*> *mapSettingUnsignedInt, CustomerSharedMemorySetting *customerSharedMemorySetting)
{
	...
	(*mapSettingUnsignedInt).insert(pair<string, unsigned int*>("LowYieldAlarm", &smCustomerSetting->LowYieldAlarm));
	...
	(*mapSettingUnsignedInt).insert(pair<string, unsigned int*>("DelayForCheckingInputOutputTableZAtSecondSigulationTrayAvalable_ms", &smCustomerSetting->DelayForCheckingInputOutputTableZAtSecondSigulationTrayAvalable_ms));
...
int MapTeachPointSignedLongProduct(map<string, signed long*> *mapTeachPointSignedLong, CustomerSharedMemoryTeachPoint *customerTeachPoint)
{
	...
	(*mapTeachPointSignedLong).insert(pair<string, signed long*>("InputTrayTableZAxisAtInputTrayStackerSecondSingulationPosition", &smCustomerTeachPoint->InputTrayTableZAxisAtInputTrayStackerSecondSingulationPosition));
	...
	(*mapTeachPointSignedLong).insert(pair<string, signed long*>("OutputTrayTableZAxisAtOutputTrayStackerSecondSingulationPosition", &smCustomerTeachPoint->OutputTrayTableZAxisAtOutputTrayStackerSecondSingulationPosition));
	...
	(*mapTeachPointSignedLong).insert(pair<string, signed long*>("S1VisionRetractPosition", &smCustomerTeachPoint->S1VisionRetractPosition));
...
int MapProductionStationResultIntProduct(map<string, int*> *mapProductionStationResultInt, CustomerSharedMemoryProduction *customerProduction)
{
	...
	for (int i = 0; i < 2; i++)
	{
		...
		sprintf_s(chVariable, sizeof(chVariable), "PickAndPlacePickUpHeadStationResult%uSelveXOffset_um", i);
		(*mapProductionStationResultInt).insert(pair<string, int*>(chVariable, &smCustomerProduction->PickAndPlacePickUpHeadStationResult[i].SelveXOffset_um));
		sprintf_s(chVariable, sizeof(chVariable), "PickAndPlacePickUpHeadStationResult%uSelveYOffset_um", i);
		(*mapProductionStationResultInt).insert(pair<string, int*>(chVariable, &smCustomerProduction->PickAndPlacePickUpHeadStationResult[i].SelveYOffset_um));
...
int MapProductionIntProduct(map<string, int*> *mapProductionInt, CustomerSharedMemoryProduction *customerProduction)
{
	...
	(*mapProductionInt).insert(pair<string, int*>("nCurrentInputQuantity", &smCustomerProduction->nCurrentInputQuantity));
	(*mapProductionInt).insert(pair<string, int*>("nCurrentOutputQuantity", &smCustomerProduction->nCurrentOutputQuantity));
	(*mapProductionInt).insert(pair<string, int*>("nCurrentRejectQuantity", &smCustomerProduction->nCurrentRejectQuantity));
	(*mapProductionInt).insert(pair<string, int*>("nCurrentLowYieldAlarmQuantity", &smCustomerProduction->nCurrentLowYieldAlarmQuantity));
	(*mapProductionInt).insert(pair<string, int*>("nCurrentRejectQuantityBasedOnInputTray", &smCustomerProduction->nCurrentRejectQuantityBasedOnInputTray));
	(*mapProductionInt).insert(pair<string, int*>("nCurrentSetupFailValue", &smCustomerProduction->nCurrentSetupFailValue));

	(*mapProductionInt).insert(pair<string, int*>("nCurrentS2FacetVisionRetryCount", &smCustomerProduction->nCurrentS2FacetVisionRetryCount));
...
int MapProductionSignedLongProduct(map<string, signed long*> *mapProductionSignedLong, CustomerSharedMemoryProduction *customerProduction)
{
	...
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PickAndPlace1XAxisMovePosition_BeforeMove", &smCustomerProduction->PickAndPlace1XAxisMovePosition_BeforeMove));
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PickAndPlace2XAxisMovePosition_BeforeMove", &smCustomerProduction->PickAndPlace2XAxisMovePosition_BeforeMove));
	...
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PickAndPlace1YAxisMovePosition_BeforeMove", &smCustomerProduction->PickAndPlace1YAxisMovePosition_BeforeMove));
	...
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PickAndPlace2YAxisMovePosition_BeforeMove", &smCustomerProduction->PickAndPlace2YAxisMovePosition_BeforeMove));
	...
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PickAndPlace1ThetaAxisMovePosition_BeforeMove", &smCustomerProduction->PickAndPlace1ThetaAxisMovePosition_BeforeMove));
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PnP1AngleMaintainance", &smCustomerProduction->PnP1AngleMaintainance));
	...
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PickAndPlace2ThetaAxisMovePosition_BeforeMove", &smCustomerProduction->PickAndPlace2ThetaAxisMovePosition_BeforeMove));
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PnP2AngleMaintainance", &smCustomerProduction->PnP2AngleMaintainance));
	
	(*mapProductionSignedLong).insert(pair<string, signed long*>("BottomXAxisoffsetMaintainance", &smCustomerProduction->BottomXAxisoffsetMaintainance));
	(*mapProductionSignedLong).insert(pair<string, signed long*>("BottomYAxisoffsetMaintainance", &smCustomerProduction->BottomYAxisoffsetMaintainance));
	(*mapProductionSignedLong).insert(pair<string, signed long*>("PnPCurrentAngle", &smCustomerProduction->PnPCurrentAngle));
...
int MapEventProduct(map<string, sEvent*> *mapEvent, CustomerSharedMemoryEvent *smCustomerEvent)
{
	...
	(*mapEvent).insert(pair<string, sEvent*>("StartS1VisionModuleMotorMoveRetractPosition", &smCustomerEvent->StartS1VisionModuleMotorMoveRetractPosition));
	(*mapEvent).insert(pair<string, sEvent*>("S1VisionModuleMotorMoveRetractPositionDone", &smCustomerEvent->S1VisionModuleMotorMoveRetractPositionDone));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_INP_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_INP_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_S2_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_S2_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_S2_PARTING_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_S2_PARTING_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_S2_FACET_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_S2_FACET_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_OUT_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_OUT_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_REJECT_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_REJECT_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_OUT_POST_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_OUT_POST_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_REJECT_POST_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_REJECT_POST_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_SETUP_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_SETUP_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_BOTTOM_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_BOTTOM_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_S3_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_S3_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_S3_PARTING_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_S3_PARTING_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_S3_FACET_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_S3_FACET_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_S1_VISION_GET_RC_NAK", &smCustomerEvent->GMAIN_RTHD_S1_VISION_GET_RC_NAK));
	...
	(*mapEvent).insert(pair<string, sEvent*>("GMAIN_RTHD_ENDLOT_UPDATE_SUMMARY_DONE", &smCustomerEvent->GMAIN_RTHD_ENDLOT_UPDATE_SUMMARY_DONE));
	...
	(*mapEvent).insert(pair<string, sEvent*>("ROUT_RTHD_REMOVE_AND_REPLACE_REJECT_TRAY_START", &smCustomerEvent->ROUT_RTHD_REMOVE_AND_REPLACE_REJECT_TRAY_START));
	(*mapEvent).insert(pair<string, sEvent*>("ROUT_RTHD_REMOVE_AND_REPLACE_REJECT_TRAY_DONE", &smCustomerEvent->ROUT_RTHD_REMOVE_AND_REPLACE_REJECT_TRAY_DONE));
	...
	(*mapEvent).insert(pair<string, sEvent*>("RMAIN_RTHD_UPDATE_MAP_AFTER_REJECT_POST_MISSING_UNIT", &smCustomerEvent->RMAIN_RTHD_UPDATE_MAP_AFTER_REJECT_POST_MISSING_UNIT));
	...
	(*mapEvent).insert(pair<string, sEvent*>("RTHD_GMAIN_UPDATE_REAL_TIME_YEILD", &smCustomerEvent->RTHD_GMAIN_UPDATE_REAL_TIME_YEILD));
	(*mapEvent).insert(pair<string, sEvent*>("RTHD_GMAIN_START_REAL_TIME_UPH", &smCustomerEvent->RTHD_GMAIN_START_REAL_TIME_UPH));
	(*mapEvent).insert(pair<string, sEvent*>("RMAIN_GMAIN_LOW_YIELD_ALARM_TRIGGER", &smCustomerEvent->RMAIN_GMAIN_LOW_YIELD_ALARM_TRIGGER));
	return 0;
}
